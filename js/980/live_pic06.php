...
<?
	$sql1  = "select A.id as album_id, A.title as titleA, A.content as contentA, B.file1, B.alt from trendyinterior_album6 as A, trendyinterior_album6_photos as B where ";
