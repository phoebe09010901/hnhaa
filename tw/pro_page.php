...
<section class="sectionWidth" style="margin: 0 auto;">
    ...
    <div class="case_info color_01 font-family_01">
        <div class="case_name line-height_40"><?=$row1['title']?></div>
        <div class="case_Line line-height_40">|</div>
        <div class="case_place line-height_40">基地位置：<?=$row1['building_site_tw']?></div>
        <div class="case_area line-height_40">基地面積：<span class="font-family_03"><?=$row1['construction_area']?> sqm</span></div>
        <div class="case_totalArea line-height_40">總樓地板面積：<span class="font-family_03"><?=$row1['total_floor_area']?> sqm</span></div>
        <div class="case_periodDesign line-height_40">設計期間：<span class="font-family_03"><?=$row1['datetime1']?></span></div>
        <div class="case_periodWork line-height_40">施工期間：<span class="font-family_03"><?=$row1['datetime2']?></span></div>
        <div class="clear"></div>
        <div class="case_info_02 color_01 font-family_01"><?=nl2br(str_replace(" ","&nbsp;",$row1['others']))?></div>
    </div>
    <?	}	?>
</section>
