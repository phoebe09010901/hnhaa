...
?>                
                    ...
                    <div class="proPic_title color_03 font-family_01" id="p_<?=$i?>"><?=$row1['title']?></div>
<?										
					}	else	{
?>                
                    <div class="proPic_block"><img src="/album/<?=$row1['file1']?>"></div>    
                    <a href="pro_page.php?id=<?=$row1['id']?>"><div class="proPic_title color_03 font-family_01" id="p_<?=$i?>"><?=$row1['title']?></div></a>
<?				
					}
				}	else	{	?>                    
