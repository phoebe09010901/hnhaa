...
if($action=='change_row') {	//update
	...
	$kw = $obj_keyword->run_mysql_out($query);//print_r($obj_keyword->result_data);
	$keywords = $kw['keywords'];
		
	$query = "select id, file1, title, alt, sort from ".$table_name."_photos where album_id='".$album_id."' order by sort desc, title asc";	
