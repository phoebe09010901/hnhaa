	...
	public function updateInit($type, $request_value) {	
		...
		switch($main_str) {
			...
			case 'proj_category':		//專案類別管理
				$this->TableFieldsType = array("id"=>"int", "prev"=>"text", "name"=>"text", "name2"=>"text", "lv"=>"int", "sort"=>"int", "file1"=>"text", "colorcode"=>"text");
				break;				

			case 'proj2_category':		//專案類別管理
				$this->TableFieldsType = array("id"=>"int", "prev"=>"text", "name"=>"text", "lv"=>"int", "sort"=>"int", "file1"=>"text", "file2"=>"text", "alt"=>"text", "colorcode"=>"text");
				break;	
			...
			case 'teacher':	//教練陣容管理
				...
				break;
			case 'album_category':	//相簿類別管理
				$this->TableFieldsType = array("id"=>"int", "name"=>"text", "name2"=>"text", "sort"=>"int");
				break;
								
			case 'album':	//相簿管理
				$this->TableFieldsType = array("id"=>"int", "category"=>"int", "album_date"=>"text", "title"=>"text", "title2"=>"text", "building_site_tw"=>"text", "building_site_en"=>"text", "construction_area"=>"text", "total_floor_area"=>"text", "datetime1"=>"text", "datetime2"=>"text", "datetime2_en"=>"text", "file1"=>"text", "type1"=>"int", "type2"=>"int", "type3"=>"int", "alt"=>"text", "sort"=>"int", "others"=>"text", "others_en"=>"text");
				break;
				
			case 'album2':	//相簿管理
				$this->TableFieldsType = array("id"=>"int", "category"=>"int", "title"=>"text", "title2"=>"text", "period"=>"text", "file1"=>"text", "file2"=>"text", "file3"=>"text", "file1_alt"=>"text", "file2_alt"=>"text", "alt"=>"text", "sort"=>"int");
				break;
			case 'album3':	//相簿管理
				$this->TableFieldsType = array("id"=>"int", "category"=>"int", "name"=>"text", "file1"=>"text", "content"=>"content", "sort"=>"int");
				break;
