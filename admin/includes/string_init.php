...
$obj_prodindex   = new mysql_page();

$obj_album = new mysql_page();		
$obj_album_category = new mysql_page();		

//table_name
$main_str_album_category    = 'album_category';
$table_name_album_category  = Proj_Name.'_'.$main_str_album_category;
...
$main_str_contactus     = 'contactus';
$table_name_contactus   = Proj_Name.'_'.$main_str_contactus;
...
$main_str_prodindex     = 'productsindex';
$table_name_prodindex   = Proj_Name.'_'.$main_str_prodindex;
...
switch(Web_Control.$this_page) {
	...
	case Web_Control.'banner.php':
		$page_title    = '首頁大圖管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'category');
		$array_search  = array('title'=>'首頁大圖標題');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
	...
	case Web_Control.'banner2.php':
		$page_title    = '產品右側廣告管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'category');
		$array_search  = array('title'=>'產品右側廣告管理');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
	...
	case Web_Control.'madeofnz_category_handle.php':
		$page_title    = '紐西蘭原料保證內文管理';
		$array_allow_search_row = array('id', 'prev', 'page_go');
		break;

	case Web_Control.'madeofnz.php':
		$page_title    = '紐西蘭原料內文管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'prev');
		$array_search  = array('content'=>'名稱');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
	...
	case Web_Control.'album_category.php':
		$page_title    = '作品類別管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords');
		$array_search  = array('title'=>'類別名稱');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
	case Web_Control.'album_category_data.php':
		$array_allow_search_row = array('name', 'name2');
		break;
	case Web_Control.'album_category_handle.php':
		$page_title    = '<span style="cursor: pointer; " onClick="location.href=\'album_category.php\';">作品類別管理</span>';
		$array_allow_search_row = array('id', 'page_go');
		break;

	case Web_Control.'album_all.php':
		$page_title    = '作品排序';
		/*		
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords');
	...
	case Web_Control.'album_handle.php':
		$page_title    = '<span style="cursor: pointer; " onClick="location.href=\'album.php?category=' . $_GET['category'] . '\';">作品專區管理</span>';
		$array_allow_search_row = array('id', 'page_go');
		break;
		
		
	case Web_Control.'album_photos.php':
		$page_title    = '作品專區相簿照片管理';
		$array_allow_search_row = array('album_id', 'page_go');
		break;
	case Web_Control.'products_category.php':
		$page_title    = '商品類別管理(大類)';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'prev');
		$array_search  = array('name'=>'類別名稱');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
	...
	case Web_Control.'products_category_handle.php':
		$page_title    = '商品類別管理(大類)編輯';
		$array_allow_search_row = array('id', 'prev', 'page_go');
		break;

	case Web_Control.'products_category2.php':
		$page_title    = '商品類別管理(中類)';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'prev');
		$array_search  = array('name'=>'類別名稱');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
	case Web_Control.'products_category2_data.php':
		$array_allow_search_row = array('action', 'data_id', 'row_name', 'row_value');
		break;
	case Web_Control.'products_category2_handle.php':
		$page_title    = '商品類別管理(中類)編輯';
		$array_allow_search_row = array('id', 'prev', 'page_go');
		break;
	...
	case Web_Control.'productsindex.php':
		$page_title    = '首頁產品管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'category');
		$array_search  = array('category'=>'詳細說明');
		$ImagesSetting = array(1=>array("_width"=>120, "_height"=>120, "_width_s"=>(100), "_height_s"=>(100), "ImgFileSize"=>5));
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
	case Web_Control.'productsindex_data.php':
		$array_allow_search_row = array('action', 'data_id', 'row_name', 'row_value');
		break;
	case Web_Control.'productsindex_handle.php':
		$page_title    = '首頁產品管理';
		$array_allow_search_row = array('id', 'category', 'page_go');
		$images_num    = 1;
		$ImagesSetting = array(1=>array("_width"=>800, "_height"=>600, "_width_s"=>(800*0.2), "_height_s"=>(600*0.2), "ImgFileSize"=>5));
	...
	case Web_Control.'products2.php':
		$page_title    = '商品資料管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords', 'category');
		$array_search  = array('name'=>'商品名稱', 'sn'=>'型　　號');
		$ImagesSetting = array(1=>array("_width"=>120, "_height"=>120, "_width_s"=>(100), "_height_s"=>(100), "ImgFileSize"=>5));
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 ...
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
	case Web_Control.'products2_data.php':
		$array_allow_search_row = array('action', 'data_id', 'row_name', 'row_value');
		break;
	case Web_Control.'products2_handle.php':
		$page_title    = '商品資料管理';
		$array_allow_search_row = array('id', 'category', 'page_go');
		$images_num    = 1;
		$ImagesSetting = array(1=>array("_width"=>800, "_height"=>600, "_width_s"=>(800*0.2), "_height_s"=>(600*0.2), "ImgFileSize"=>5));
	...
	case Web_Control.'member.php':
		$page_title    = '會員資料管理';
		$array_allow_search_row = array('action', 'page_go', 'search_row', 'keywords');
		$array_search  = array('name'=>'會員姓名', 'email'=>'E-mail');
		$jqxButionList = '$(\'.batchButton2\').jqxButton({ width: 100, height: 25, theme: theme });'.
						 '$(\'#prevpageButton\').jqxButton({ width: 25, height: 25, theme: theme });'.
						 '$(\'#nextpageButton\').jqxButton({ width: 25, height: 25, theme: theme });';
		break;
