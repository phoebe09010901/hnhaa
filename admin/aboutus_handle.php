...
//subtitle
$page_subtitle = '<li class="left"><a href="aboutus.php?category='.$category.'">品牌精神內文管理</a></li>';
?><!DOCTYPE HTML>
<html>
<head>
   		...
   		<form method="post" id="<?=$main_str?>_form" action="<?=$_SERVER['PHP_SELF']?>">
            ...
            <table class="<?=$main_str?>-table">
                <tr>
                    <td height="60">內　　容：</td>
                    <td>
                    	<strong>圖片尺寸最大不得超過 963px</strong><br>
                    	<textarea id="content" name="content" rows="10"><?=stripslashes($news['content'])?></textarea>
					</td>
                </tr>               
                <tr>
