...
$images_num = 1;
//subtitle
$page_subtitle = '<li class="left"><a href="madeofnz_category.php?category='.$category.'">紐西蘭原料保證管理</a></li>';
   		...
   		<form method="post" id="<?=$main_str?>_form" action="<?=$_SERVER['PHP_SELF']?>">
            ...
            <table class="<?=$main_str?>-table">
                ...
                <tr>
                    ...
                    <td><textarea id="content" name="content" rows="10"><?=stripslashes($cate['content'])?></textarea></td>
                </tr>
                <tr>
