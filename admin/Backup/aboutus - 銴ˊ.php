...
?>
	<script>location.replace('aboutus_handle.php?id=6');</script>
<?	
	break;
}
...
?>
	<script>location.replace('aboutus_handle.php?id=7');</script>
<?	
	break;
}
...
?>
	<script>location.replace('aboutus_handle.php?id=8');</script>
<?	
	break;
}
