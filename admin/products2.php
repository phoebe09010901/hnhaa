...
//data list
if($category)
	$where_str = "and category2=".$category;
if($search_row) {
...
if($category!=0) {		
	...
	$query = "select id, name, prev, lv from health_products_category where id='".$pc['prev']."'";
	$pc = $obj_cate1->run_mysql_out($query);

	$page_subtitle = "<a href=\"products_category2.php?prev=".$pc['id']."\"><li class='left'>" . $pc['name'] . "</li></a>";				
